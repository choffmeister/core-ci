...
namespace CoreCI.Tests.Server.Hooks
{
    ...
    public class GitHubHookTest
    {
        ...
        {
            InMemoryRepository<ProjectEntity> projectRepository = new InMemoryRepository<ProjectEntity>();
            InMemoryRepository<TaskEntity> taskRepository = new InMemoryRepository<TaskEntity>();
            GitHubHook gitHubHook = new GitHubHook(projectRepository, taskRepository);
            ...
            Assert.AreEqual(1, projectRepository.Count());
            ProjectEntity project = projectRepository.Single();
            ...
            Assert.AreEqual(1, projectRepository.Count());
            Assert.AreEqual(2, taskRepository.Count());
        }
    }
}
